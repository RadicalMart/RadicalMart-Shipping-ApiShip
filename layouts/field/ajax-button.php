 ...
 * @var  string|null $task           Ajax task.
 * @var  int         $shipping       Shipping method id.
 * @var  string|null $icon           Button icon.
 * @var  string|null $text           Button text.
 * @var  string|null $client         Link client.
 * @var  string|null $link           Button Link.
 */
