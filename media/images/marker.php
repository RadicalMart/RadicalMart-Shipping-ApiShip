...
$color   = (!empty($_GET['color'])) ? $_GET['color'] : '000000';
$size    = (isset($_GET['size']) && (int) $_GET['size']) ? (int) $_GET['size'] : 20;
$opacity = (isset($_GET['opacity']) && (float) $_GET['opacity']) ? (float) $_GET['opacity'] : false;
?>
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	<?php echo ($opacity) ? 'style="opacity:' . $opacity . '"' : ''; ?>>
