...
class PointsFilesFieldAssetItem extends WebAssetItem implements WebAssetAttachBehaviorInterface
{
	/**
	...
	{
		$optionsKey = 'plg_radicalmart_shipping_apiship.field.points.files';
